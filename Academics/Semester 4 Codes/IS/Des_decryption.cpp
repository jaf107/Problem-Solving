...
string shiftLeftOnce(string key_chunk)
{
    string shifted="";
    for(int i = 1; i < 28; i++)
    {
...
string shiftLeftTwice(string key_chunk)
{
    string shifted="";
    for(int i = 0; i < 2; i++)
    {
...
//        S box Substion
    ...
    for(int i = 0; i < 64; i++)
    {
        ciphertext+= combinedText[inversePermutation[i]-1];
    }
    return ciphertext;
}
int main()
{
    string key= "1010101010111011000010010001100000100111001101101100110000000001";
    pt= "1010101111001101111001101111100001001101000100110010010100110110";
    string apt = pt;
    generateKeys(key);
